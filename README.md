<p align="center">
  ...
  <p align="center">
    <a href="https://github.com/Shaw-fung/clash-rules-lite/blob/master/.github/workflows/release.yml">
    <img src="https://github.com/Shaw-fung/clash-rules-lite/actions/workflows/release.yml/badge.svg" />
    </a>
  </p>
 
  <p align="center">
    <a href="https://github.com/Shaw-fung/clash-rules-lite/blob/main/proxy-rules.txt">代理规则列表</a> |
    <a href="https://github.com/Shaw-fung/clash-rules-lite/blob/main/microsoft-rules.txt">微软服务规则列表</a> |
    <a href="https://github.com/Shaw-fung/clash-rules-lite/blob/main/blacklist-rules.txt">黑名单规则列表</a>
  </p>
...
<p>
  <pre align="center">
  https://cdn.jsdelivr.net/gh/Shaw-fung/clash-rules-lite@release/proxy-rules.txt    
  https://cdn.jsdelivr.net/gh/Shaw-fung/clash-rules-lite@release/microsoft-rules.txt
  https://cdn.jsdelivr.net/gh/Shaw-fung/clash-rules-lite@release/blacklist-rules.txt</pre>
</p>
<p align="center">
已稳定使用2年的机场推荐：https://sspcloud.net/
</p>
...
+ 代理规则放在github仓库中方便多设备同步，只需编辑[rules.txt](https://github.com/Shaw-fung/clash-rules-lite/blob/main/rules.txt)即可
+ 当用户更新规则后，使用Github Actions自动将规则缓存到免费CDN上 
+ 用户在 github 上更新规则后，在 clash 的 providers 上点击刷新即可拉取更新


### 如何自定义
1. fork 本仓库：[Fork zhanyeye/clash-rules-lite](https://github.com/Shaw-fung/clash-rules-lite/fork) 
...
rule-providers:
  Proxy:
    type: http
    behavior: classical
    url: "https://cdn.jsdelivr.net/gh/Shaw-fung/clash-rules-lite@release/proxy-rules.txt"
    path: ./providers/rule-proxy.yaml
    interval: 86400
  Microsoft:
    type: http
    behavior: classical
    url: "https://cdn.jsdelivr.net/gh/Shaw-fung/clash-rules-lite@release/microsoft-rules.txt"
    path: ./providers/rule-microsoft.yaml
    interval: 86400
  Backlist:
    type: http
    behavior: classical
    url: "https://cdn.jsdelivr.net/gh/Shaw-fung/clash-rules-lite@release/blacklist-rules.txt"
